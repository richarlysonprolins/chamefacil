<template>
  <v-container fluid class="pa-0  ma-0 fill-height">
    <v-card flat tile class="pa-6 ma-0 fill-height larguratoda" >
        ...
        <FormGrupoFila v-model="openForm"
...
<script setup>
import { ref } from 'vue'
import FormGrupoFila from '../components/Forms/FormGrupoFila.vue'
...
const headers = ref([
  { title: "Nome", key: "grupo" }, 
  { title: "Status", key: "status", sortable: false},
  { title: "Editar", key: "editar", sortable: false }
])

const filas = ref([
  { grupo: "totem teste", status: "", editar: "" }
]);
