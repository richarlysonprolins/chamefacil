<template>
  <v-container fluid class="pa-0  ma-0 fill-height">
    <v-card flat tile class="pa-6 ma-0 fill-height larguratoda" >
        ...
        <FormProgramacao v-model="openForm"
...
<script setup>
import { ref } from 'vue'
import FormProgramacao from '../components/Forms/FormProgramacao.vue'
...
const filas = ref([
  { nome: "Atendimento 1", status: "", editar: "" }
]);
