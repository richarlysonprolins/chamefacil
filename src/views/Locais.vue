...
const filas = ref([
  { posicao: "", configurar: "", nome: "Atendimento 1", sigla: "SN", descricao: "Normal", unidade: "EEEP Jaime Alencar de Oliveira", intervalo: "1 a 500", grupo: "", tempoEspera: "10", tempoAtendimento: "10", status: "", editar: "" }
]);
