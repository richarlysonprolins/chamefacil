<template>
  <v-container fluid class="pa-0  ma-0 fill-height">
    <v-card flat tile class="pa-6 ma-0 fill-height larguratoda" >
        <v-row>
            ...
            <v-col class="d-flex justify-end">
                <v-btn
                    ...
                    variant="flat"
                    @click="abrirForm()"
                    >Cadastrar Usuário-Unidade</v-btn>
            </v-col>
        </v-row>
        <v-row>
            <v-col cols="12" md="10">
        ...
        <FormUsuarioUnidade v-model="openForm"
...
<script setup>
import { ref } from 'vue'
import FormUsuarioUnidade from '../components/Forms/FormUsuarioUnidade.vue'
...
const headers = ref([
  ...
  { title: "", key: "deletar", sortable: false}
])

const filas = ref([
  { unidade: "EEEP Jaime Alencar de Oliveira", atendente: "Chamebelo do Santander", deletar: "" }
]);
